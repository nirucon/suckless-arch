...
static const char col_darkgray[]    = "#000001"; /* dark black */
static const unsigned int baralpha = 0xd0;
static const unsigned int borderalpha = OPAQUE;
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_green, col_black, col_gray },
	[SchemeSel]  = { col_red, col_darkgray,  col_green },
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_black, "-nf", col_green, "-sb", col_darkgray, "-sf", col_red, NULL };

...
static const char *fonts[]          = { "Liberation Mono:pixelsize=13:antialias=true:autohint=true" };
...
static const char *colors[][3]      = {
	/*               fg         bg         border   */
    [SchemeNorm] = { "#9ACD32", "#202020", "#556B2F" }, // Dark green
    [SchemeSel]  = { "#FFD700", "#556B2F", "#8B4513" }, // Gold and brown
